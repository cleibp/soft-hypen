<h1 align="center"> 🚀 Soft Hypen </h1>

## ✍️ Descrição
Exemplificação de Soft Hypen
...
1. Clone:
    ...
    ```bash
    git clone git@github.com:cleibp/soft-hypen.git
    ```
1. Download:
    ### Download Manual
...
## 👋🏽 DEMO
[Publicação em Codepen](https://codepen.io/cleibp/pen/zYJGNaY) 
